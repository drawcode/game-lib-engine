...
public class ContentsConfig {   
        ...
        // Path will look like 'StreamingAssets/vehicle-shoot/vehicle-shoot-1'  
	...
	// Should be all lower case and dashes since it is used in urls on the S3 dynamic data fetch i.e. 'project-1'
