...
namespace Engine.Game.App.BaseApp
{
    ...
    public partial class GameAchievement : BaseGameAchievement
    {
        ...
        /*
        public void ConvertFilterToStatisticSet(Dictionary<string,object> filterData) {
            GameFilterStatisticSingle filter = new GameFilterStatisticSingle();
            if(filterData.ContainsKey
